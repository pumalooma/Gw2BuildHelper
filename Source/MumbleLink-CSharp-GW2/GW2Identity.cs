...
namespace MumbleLink_CSharp_GW2
{
    public class GW2Identity
    {
        ...
        [JsonConstructor]
        public GW2Identity(string name, GW2Profession profession, GW2Race race, int map_id, long world_id, int team_color_id, bool commander, float fov)
        {
            Name = name;
